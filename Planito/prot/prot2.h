...
static inline NSData* asdasdweosdfl() //mac address
{
...
static inline NSData* asdasddsfq() //apple root cert
{
	OSStatus status;
...
static inline NSDictionary* akdjhaklj2oi3jkslads (NSString *receiptFilePath) //dict for receipt
{
	NSData * rootCertData = asdasddsfq();
...
static inline BOOL ouqw398eu2398uid()
{
    ...
    NSDictionary *d = akdjhaklj2oi3jkslads([[[NSBundle mainBundle] appStoreReceiptURL] path]);
...
#define CHECK_PROT ouqw398eu2398uid